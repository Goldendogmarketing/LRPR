...
-- Account dashboard: vendors a public/free user has saved. vendor_id
-- references a service_provider_profiles row; name/category are snapshotted
-- so the list still renders if the provider row is later removed.
